...
from gzreduction.panoptes_api.api import api_to_json, reformat_api_like_exports
from gzreduction.deprecated import panoptes_to_subjects
from gzreduction.deprecated.spark import aggregate
...
if __name__ == '__main__':
    ...
    # assert os.path.isdir(hardcoded_python)
